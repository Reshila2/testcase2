                        ...
                        <!-- form start -->
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $news['heading'] }}" name="heading" class="form-control"
                                           id="exampleInputEmail1" placeholder="Введите название заголовка" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Анонс</label>
                                    <input type="text" value="{{ $news['heading'] }}" name="anons" class="form-control" id="exampleInputEmail1"
                                           placeholder="{{ $news['heading'] }}" required>
                                </div>
                                <div class="form-group">
